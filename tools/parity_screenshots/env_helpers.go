...
func printUsage() {
	...
	fmt.Println("  QUAKE_BASEDIR  Path to Quake data (default: QUAKE_DIR, else ./quake-data symlink)")
	fmt.Println("  IRONWAIL_BIN   Path to C Ironwail binary (default: ./ironwail/Linux/ironwail via ./ironwail symlink)")
