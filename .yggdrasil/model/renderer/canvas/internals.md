...
This layer computes logical-to-physical drawing transforms and shared camera/screen helpers that let the canonical GoGPU runtime and lower shared helper packages expose the same 2D/3D coordination model.
...
- Canvas semantics must stay consistent across the renderer package surface and canonical GoGPU runtime.
