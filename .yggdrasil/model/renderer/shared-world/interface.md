...
- shared sky helpers expose `readWorldFastSkyEnabled` and `buildSkyFlatRGBA` so backend world runtimes can read `r_fastsky` and derive deterministic flat-sky colors from embedded sky alpha layers
