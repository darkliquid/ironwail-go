...
- `BuildVerticesInterpolatedInto` lets callers provide/reuse destination vertex storage while preserving existing interpolation, scaling, and yaw/full-angle behavior
