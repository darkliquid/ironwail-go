...
- Renderer-facing visual helpers use narrow role contracts (`gameRendererLights` for dynamic lights and `gameRendererAssets` for skybox binding) instead of requiring a full renderer composite at each helper boundary.
