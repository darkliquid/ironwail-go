...
// maxNodeSize mirrors ericw-tools' default maxnodesize option: nodes larger
// than this in any dimension use the simpler midsplit heuristic instead of
// the per-brush split scoring (the AUTO policy's budget guard).
const maxNodeSize = 1024.0
